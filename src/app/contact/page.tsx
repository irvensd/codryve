              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-3 bg-gray-700/50 border rounded-md text-white focus:outline-none focus:border-blue-400 transition-colors duration-300 ${
                ...
                <button
                  type="submit"
                  className="w-full py-3 bg-blue-400 text-gray-900 rounded-md font-light hover:bg-blue-500 transition-colors duration-300 flex items-center justify-center"
                >
              ...
              <div className="bg-gray-800/50 backdrop-blur-sm p-8 rounded-lg border border-gray-700/50">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <FaEnvelope className="w-6 h-6 text-blue-400 mt-1" />
                    <div className="ml-4">
                      <h3 className="text-lg font-light text-white">Email</h3>
                      <p className="text-gray-400">contact@codryve.com</p>
                    </div>
                  </div>

                  <div className="flex items-start">
                    <FaPhone className="w-6 h-6 text-blue-400 mt-1" />
                    <div className="ml-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-4">
                      <h3 className="text-lg font-light text-white">Location</h3>
